...
public abstract class DefaultCursor$$anon$1<A>  {
	...
	@Trace(async=true)
	public <M> Future<M> collect(int i,Function2<M, java.lang.Throwable, reactivemongo.api.Cursor.State<M>> f1,scala.collection.Factory<A, M> cbf,ExecutionContext ec) {
